...
#endif
static const char *ng0 = "D:/study/COD lab/test2/13/cpupipline/ALU.v";
...
LAB64:    xsi_set_current_line(67, ng0);
    ...
    t3 = ((char*)((ng14)));
    memset(t9, 0, 8);
    xsi_vlog_signed_not_equal(t9, 32, t4, 32, t3, 32);
    t7 = (t9 + 4);
    t11 = *((unsigned int *)t7);
    t12 = (~(t11));
    t13 = *((unsigned int *)t9);
...
LAB46:    xsi_vlog_unsigned_bit_combine(t9, 32, t21, 32, t26, 32);
    goto LAB50;

LAB48:    memcpy(t9, t21, 8);
    goto LAB50;
...
LAB59:    xsi_vlog_unsigned_bit_combine(t9, 32, t30, 32, t31, 32);
    goto LAB63;

LAB61:    memcpy(t9, t30, 8);
    goto LAB63;
...
LAB65:    xsi_set_current_line(68, ng0);
    ...
    t21 = *((char **)t8);
    memset(t10, 0, 8);
    xsi_vlog_signed_divide(t10, 32, t17, 32, t21, 32);
    t8 = (t0 + 3672);
...
extern void work_m_00000000003022528845_0886308060_init()
{
	static char *pe[] = {(void *)Always_43_0,(void *)Always_49_1};
	xsi_register_didat("work_m_00000000003022528845_0886308060", "isim/test_isim_beh.exe.sim/work/m_00000000003022528845_0886308060.didat");
